...
C {devices/code.sym} -1090 -210 0 0 {name=DC_sweep_simulation only_toplevel=false 
value="
.save all
...
C {code.sym} -1090 -360 0 0 {name=POWER_MOS_Parameters only_toplevel=false 
...
"}
C {sg13g2_pr/sg13_hv_nmos.sym} -720 -110 2 1 {name=M3
l=\{l_M2\}
w=\{w_M2\}
ng=\{ng_M2\}
m=\{mult_M2\}
...
C {sg13g2_pr/sg13_hv_pmos.sym} -500 -110 0 0 {name=M4
l=\{l_M1\}
w=\{w_M1\}
ng=\{ng_M1\}
m=\{mult_M1\}
