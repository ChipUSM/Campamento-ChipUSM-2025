...
N -700 -80 -700 -50 {
lab=GND}
C {vsource.sym} -660 -360 0 0 {name=Vg value=1.8 savecurrent=false}
C {vsource.sym} -580 -360 0 0 {name=Vds value=1.8 savecurrent=false}
...
C {vsource.sym} -510 -360 0 0 {name=Vdd value=1.8 savecurrent=false}
C {lab_pin.sym} -510 -420 0 0 {name=p5 sig_type=std_logic lab=Vdd}
C {devices/code.sym} -1130 -190 0 0 {name=DC_sweep_simulation only_toplevel=false 
value="
.save all
...
*let G_M2 = Ids_M2/(Vds_M2)
let G_M2 = @m.xm2.msky130_fd_pr__nfet_01v8[gds]
let Ron_M2 = 1/G_M2
let I_M2 = i(VdM2)
...
meas dc I_M2 FIND Ids_M2 AT=100m
...
meas dc I_M1 FIND Isd_M1 AT=1.7
...
C {vsource.sym} -750 -360 0 0 {name=Vd_M1 value=1.8 savecurrent=false}
C {lab_pin.sym} -750 -420 0 0 {name=p6 sig_type=std_logic lab=Vd_p}
C {code.sym} -1130 -350 0 0 {name=MODEL only_toplevel=true spice_ignore=false
...
"}
C {sky130_fd_pr/nfet_01v8.sym} -720 -110 0 0 {name=M2
W=\{w_M2\}
L=\{l_M2\}
nf=\{ng_M2\}
mult=\{mult_M2\}
...
C {sky130_fd_pr/pfet_01v8.sym} -500 -110 0 0 {name=M1
W=\{w_M1\}
L=\{l_M1\}
nf=\{ng_M1\}
mult=\{mult_M2*3\}
...
C {code.sym} -1020 -350 0 0 {name=GD_MOS_Parameters only_toplevel=false 
