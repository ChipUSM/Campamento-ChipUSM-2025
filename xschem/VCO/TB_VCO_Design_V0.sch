...
lab=VdsMN1}
N 3280 -1160 3340 -1160 {
lab=V_1}
N 3280 -1120 3310 -1120 {
lab=V_2}
N 3090 -1140 3090 -1130 {
lab=VCONT}
N 3090 -1070 3090 -1050 {
lab=GND}
N 3090 -1140 3160 -1140 {
lab=VCONT}
N 3220 -1230 3220 -1200 {
lab=Vdd}
N 3220 -1080 3220 -1050 {
lab=GND}
N 3090 -1050 3220 -1050 {
lab=GND}
...
C {vsource.sym} 2490 -1370 0 0 {name=VdMP1 value=3.3 savecurrent=false}
C {gnd.sym} 2490 -1340 0 0 {name=l2 lab=GND}
C {vsource.sym} 2090 -1500 0 0 {name=VgMP1 value=3.3 savecurrent=false}
...
C {devices/code.sym} 1630 -1010 0 0 {name=DCSim only_toplevel=false spice_ignore=false
value="
.save all
...
C {devices/lab_pin.sym} 3130 -1140 1 0 {name=p11 sig_type=std_logic lab=VCONT}
C {devices/lab_pin.sym} 3310 -1160 1 0 {name=p18 sig_type=std_logic lab=V_1}
C {devices/lab_pin.sym} 3310 -1120 1 0 {name=p19 sig_type=std_logic lab=V_2}
C {vsource.sym} 3090 -1100 0 0 {name=Vcont value=\{Vcont\} savecurrent=false}
C {../VCO/VCO_V0.sym} 3220 -1140 0 0 {name=x1}
C {devices/lab_pin.sym} 3220 -1230 1 0 {name=p21 sig_type=std_logic lab=Vdd}
...
C {ngspice_get_value.sym} 2700 -970 0 0 {name=r6 
node=Vth_M2
descr="Vth="}
...
C {code.sym} 1950 -1010 0 0 {name=VCO_param_Ki_2.34M/V_fo_3.66MHz only_toplevel=true spice_ignore=0
format="tcleval( @value )"
value="
