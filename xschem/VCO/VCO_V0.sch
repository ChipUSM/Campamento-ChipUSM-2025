...
C {../VCO/stage_IHP.sym} -310 -10 0 0 {name=x1}
C {../VCO/stage_IHP.sym} -120 -10 0 0 {name=x2}
C {../VCO/stage_IHP.sym} 70 -10 0 0 {name=x3}
C {../VCO/stage_IHP.sym} 260 -10 0 0 {name=x4}
C {../VCO/stage_IHP.sym} 450 -10 0 0 {name=x5}
